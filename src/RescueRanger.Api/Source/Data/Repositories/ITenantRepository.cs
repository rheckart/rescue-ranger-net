...
public interface ITenantRepository
{
    ...
    Task<Result<TenantInfo>> GetBySubdomainAsync(string subdomain);
    ...
    /// <returns>TenantInfo if found, null otherwise</returns>
    Task<Result<TenantInfo>> GetByIdAsync(Guid tenantId);
    ...
    Task<Result<Tenant>> GetTenantEntityByIdAsync(Guid tenantId);
    ...
    Task<Result<bool>> ValidateTenantStatusAsync(Guid tenantId);
